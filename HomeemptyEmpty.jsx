...
import HomeemptyEmpty from "./HomeemptyEmpty";
...
export default function HomeemptyPage() {
    return (
        <>
            <Helmet>
                <title>HomeemptyEmpty Application</title>
            ...
            <div className="w-full overflow-x-scroll bg-[#ffffff]">
                <div className="flex flex-col gap-5">
                    ...
                    <div className="mx-24 flex gap-5 md:mx-0">
                        <Sidebar11 className="gray_50_33_white_Q700_33_border-solid shadow-[4px_4px_10px_0_#0000000c]" />
                        <div className="flex flex-1 items-start gap-[18px] md:flex-col">
                            ...
                            <div className="flex w-[28%] flex-col items-end gap-4 self-stretch">
                                <div className="flex flex-col items-end gap-4 self-stretch">
                                    <div className="flex flex-col items-start justify-center gap-3.5 self-stretch rounded-lg bg-[#ffffff]">
                                    ...
                                    <Button
                                        className="iconbutton_border mr-2 w-[42px] !rounded-bl-[12px] !rounded-tl-[12px] bg-gradient-to-b from-[#8585d5] to-[#6767b7] px-1.5 shadow-[inset_0_-2.67px_1px_0_#00000019] md:mr-0"
                                        shape="round"
                                        variant={null}
                                    >
                                ...
                                <Img src="images/img_refresh.png" alt="Refresh" className="mr-2 h-[26px] object-cover md:mr-0" />
                            </div>
                        </div>
                    </div>
                </div>
