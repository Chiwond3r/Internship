...
export default function ThenaticgroupcreatedColumn() {
    return (
        <div className="mb-4 flex w-[62%] flex-col gap-3 md:w-full">
                    ...
                    <div>
                        <div className="flex items-center justify-center bg-[#ffffff] p-4 sm:flex-col">
                            <div className="flex flex-1 gap-[18px] sm:self-stretch">
                                ...
                                <div className="fleex flex-1 flex-col items-start">
                        ...
                        <div className="bg-[#ffffff] px-4">
                            <Text sixe="body_text" as="p" className="mb-4 text-[14px] font-normal leading-[tracking-[-0.41px]">
                                A communityndedicated to communicating climate & justice. Another world is possible Join us.
                            </Text>
                        </div>
                ...
                <div className="mr-1 flex items-start justify-between gap-5 rounded-md border border-solid border-[#ebecef] bg-[#ffffff] px-2.5 py-3.5 md:mr-0 sm:flex-col">\
                    ...
                    <div className="flex flex-1 flex-col gap-2.5 self-center sm:self-stretch">
                        ...
                        <div className="flex items-center justify-center">
                            <div className="flex flex1 gap-[9px]">
            ...
            <div className="m-1 flex flex-col items-center justify-center gap-2.5 rounded-md border-[0.95px] border-solid border-[#ebecef] bg-[#ffffff] p-[54px[ md:;r-0 md:p-5">
                <Img
